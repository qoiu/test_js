 ...
 */
                    ...
                    outerFunction(innerFunction); // Передаем innerFunction как аргумент

                    window._test_outer = function () {
                        return outerFunction(innerFunction)
                    }

                    function helloWorld() {
                        console.log("Crypto pro hello")
                    }

                    window._helloWorld2 = function (text) {

                        helloWorld()
                        console.log(text);
                    };

                    window._init_crypto_pro = function () {
                        var result = utf8ToBytes('test')
                        console.log(result);
                        createHash();
                    }


                    window.checkPlugin = function () {
...
// ================
                    ...
                    window._loadExtention = function () {

                        console.log('loadExtention')
                        _check_browser()
                    }
                    /* WEBPACK VAR INJECTION */
  ...
  \******************************************************************/
            /*! no static exports found */
            /***/
                window._cds_plugin = (function (module, exports) {
                    ...
                    ;(function () {
                        ...
                        window._check_browser = function () {
                            console.log('_check_browser')
                            check_browser()
                        }
                        ...
                        window._test_check_browser = function () {
                        ...
                        window.__check_plugin_working = function () {
                            return check_plugin_working();
                        }
...
// easier to handle this case. if(!global) { ...}
  ...
  \*****************************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                window._cadies = function () {

                    var test = getCadesProp
                ...
                exports.getDecodedExtendedKeyUsage = _afterPluginsLoaded_1._afterPluginsLoaded(function () {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.getExtendedKeyUsage()];
                                case 1:
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    return [2 /*return*/, _parseCertInfo_1._parseCertInfo(tags, entities)];
                            }
                        });
                    });
                });
  ...
  \****************************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                (function (Buffer) {
                     ...
                     */
                    exports.createAttachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, unencryptedMessage) {
  ...
  \****************************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 * @returns подпись в формате PKCS#7
                 */
                exports.createDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, messageHash, options) {
                    return __awaiter(void 0, void 0, void 0, function () {
                        var cadesplugin, cadesCertificate;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
  ...
  \***************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                (function (Buffer) {
                     ...
                     * @returns хеш
                     */
                    exports.createHash = _afterPluginsLoaded_1._afterPluginsLoaded(function (unencryptedMessage, options) {
                        return __awaiter(void 0, void 0, void 0, function () {
                            var cadesplugin;
                            return __generator(this, function (_a) {
                                cadesplugin = window.cadesplugin;
  ...
  \***********************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 * @returns подпись
                 */
                exports.createXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, unencryptedMessage, options) {
                    return __awaiter(void 0, void 0, void 0, function () {
                        var cadesplugin, cadesCertificate;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function createXMLSignature() {
                                        ...
                                        try {
                                            var signatureMethod = (_a = options === null || options === void 0 ? void 0 : options.signatureMethod) !== null && _a !== void 0 ? _a : cadesplugin.XmlDsigGost3410Url2012256;
                                            var digestMethod = (_b = options === null || options === void 0 ? void 0 : options.digestMethod) !== null && _b !== void 0 ? _b : cadesplugin.XmlDsigGost3411Url2012256;
                                            void (_generateCadesFn_1.__cadesAsyncToken__ + cadesSigner.propset_Certificate(cadesCertificate));
  ...
  \************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 */
                exports.execute = _afterPluginsLoaded_1._afterPluginsLoaded(function (callback) {
                    return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
  ...
  \*******************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 * @returns сертификат
                 */
                exports.getCertificate = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint) {
                    return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    foundCertificate = availableCertificates.find(function (cert) {
  ...
  \***********************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 */
                exports.isValidSystemSetup = _afterPluginsLoaded_1._afterPluginsLoaded(function () {
                    return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!isPluginLoaded) {
                                            try {
                                                __webpack_require__(/*! cadesplugin_api.js */ "../node_modules/cadesplugin_api.js/dist/cadesplugin_api.js");
                                            } catch (error) {
                                                console.error(error);
  ...
  \***************************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                Object.defineProperty(exports, "__esModule", {value: true});
                exports._extractCommonName = function (subjectName) {
                    var _a;
...
// синтетические переменные, которые подменяются в рантайме
  ...
  \********************************/
            ...
            /***/ (function (module, exports, __webpack_require__) {
                 ...
                 */
                exports._getDateObj = function (dateObj) {
                    return (dateObj.getVarDate ? dateObj.getVarDate() : dateObj);
                };
                ...
                exports._parseCertInfo = function (tagsTranslations, rawInfo) {
                    ...
                    if (extractedEntities) {
                        return extractedEntities.map(function (group) {
                            ...
                            var tagTranslation = (_c = tagsTranslations.find(function (tag) {
